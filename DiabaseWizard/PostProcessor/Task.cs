...
namespace DiabaseWizard
{
    static class PostProcessor
    {
        ...
        public static async Task CreateTask(FileStream topAdditiveFile, FileStream topSubstractiveFile,
            ...
            FileStream outFile, SettingsContainer settings, Duet.MachineInfo machine,
            IProgress<string> textProgress, IProgress<int> progress, IProgress<int> maxProgress, IProgress<int>totalProgress)
        {
            ...
            try
            {
                ...
                // Additive Top
                GCodeProcessor topAdditiveGCode = new GCodeProcessor(topAdditiveFile, settings, machine, progress, maxProgress);
                ...
                {
                    bottomAdditiveGCode = new GCodeProcessor(bottomAdditiveFile, settings, machine, progress, maxProgress);
